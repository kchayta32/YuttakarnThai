...
export const CAMPAIGN1_MAPS = {
    ...
    campaign1_mission8: {
        ...
        playerUnits: [
            // Wall defenders
            { type: 'swordsman', x: 2200, y: 1000, team: 0 },
            { type: 'swordsman', x: 2250, y: 1000, team: 0 },
            { type: 'swordsman', x: 2300, y: 1000, team: 0 },
            { type: 'swordsman', x: 2200, y: 1050, team: 0 },
            { type: 'swordsman', x: 2250, y: 1050, team: 0 },
            { type: 'swordsman', x: 2300, y: 1050, team: 0 },
            { type: 'spearman', x: 2150, y: 1000, team: 0 },
            { type: 'spearman', x: 2150, y: 1050, team: 0 },
            { type: 'spearman', x: 2350, y: 1000, team: 0 },
            { type: 'spearman', x: 2350, y: 1050, team: 0 },
            // Archers on walls
            { type: 'archer', x: 2200, y: 950, team: 0 },
            { type: 'archer', x: 2250, y: 950, team: 0 },
            { type: 'archer', x: 2300, y: 950, team: 0 },
            { type: 'archer', x: 2200, y: 1100, team: 0 },
            { type: 'archer', x: 2250, y: 1100, team: 0 },
            { type: 'archer', x: 2300, y: 1100, team: 0 },
            // Elephants
            { type: 'elephant', x: 2400, y: 1025, team: 0 },
            { type: 'elephant', x: 2450, y: 1025, team: 0 },
            // Cavalry reserve
            { type: 'cavalry', x: 2450, y: 950, team: 0 },
            { type: 'cavalry', x: 2450, y: 1000, team: 0 },
            { type: 'cavalry', x: 2450, y: 1050, team: 0 },
            { type: 'cavalry', x: 2450, y: 1100, team: 0 }
        ],

        // Attacking Burmese
        enemyUnits: [
            // Main assault (Shifted right of Burmese camp at 350)
            { type: 'enemy_swordsman', x: 700, y: 1050, team: 1 },
            { type: 'enemy_swordsman', x: 750, y: 1050, team: 1 },
            { type: 'enemy_swordsman', x: 800, y: 1050, team: 1 },
            { type: 'enemy_swordsman', x: 850, y: 1050, team: 1 },
            { type: 'enemy_swordsman', x: 700, y: 1100, team: 1 },
            { type: 'enemy_swordsman', x: 750, y: 1100, team: 1 },
            { type: 'enemy_swordsman', x: 800, y: 1100, team: 1 },
            { type: 'enemy_swordsman', x: 850, y: 1100, team: 1 },
            { type: 'enemy_swordsman', x: 700, y: 1150, team: 1 },
            { type: 'enemy_swordsman', x: 750, y: 1150, team: 1 },
            { type: 'enemy_swordsman', x: 800, y: 1150, team: 1 },
            { type: 'enemy_swordsman', x: 850, y: 1150, team: 1 },
            { type: 'enemy_spearman', x: 650, y: 1075, team: 1 },
            { type: 'enemy_spearman', x: 650, y: 1125, team: 1 },
            { type: 'enemy_archer', x: 600, y: 1000, team: 1 },
            { type: 'enemy_archer', x: 600, y: 1050, team: 1 },
            { type: 'enemy_archer', x: 600, y: 1100, team: 1 },
            { type: 'enemy_archer', x: 600, y: 1150, team: 1 },
            { type: 'enemy_archer', x: 600, y: 1200, team: 1 },
            { type: 'enemy_elephant', x: 900, y: 1075, team: 1 },
            { type: 'enemy_elephant', x: 900, y: 1125, team: 1 },
            { type: 'enemy_elephant', x: 950, y: 1100, team: 1 },
            { type: 'enemy_cavalry', x: 600, y: 875, team: 1 },
            { type: 'enemy_cavalry', x: 600, y: 925, team: 1 },
            { type: 'enemy_cavalry', x: 600, y: 1225, team: 1 },
            { type: 'enemy_cavalry', x: 600, y: 1275, team: 1 }
        ],

        buildings: [
            // City defenses
            { type: 'kamphaeng_phet_wall', x: 2750, y: 1100, team: 0 },
            { type: 'portuguese_camp', x: 3050, y: 850, team: 0 },
