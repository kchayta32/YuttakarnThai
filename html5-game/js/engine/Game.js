...
export class Game {
    ...
    saveSettings() {
        ...
        this.settings.hqShadows = document.getElementById('hq-shadows')?.checked ?? true;
        this.settings.terrainDetails = document.getElementById('terrain-details')?.checked ?? true;
        this.settings.propsDetail = document.getElementById('props-detail')?.checked ?? true;
        ...
        // Apply visual settings to renderers
        if (this.terrainRenderer) {
            this.terrainRenderer.settings.decalsEnabled = this.settings.terrainDetails;
            this.terrainRenderer.settings.propShadowEnabled = this.settings.hqShadows;
        }

        if (this.unitRenderer) {
            this.unitRenderer.settings.shadowEnabled = this.settings.hqShadows;
        }
    }
